         ...
         <div class="col-lg-12">
            <div class="card card-default">
               ...
               <div class="card-footer">
                  <a href="/quotation/listing" class="btn btn-info btn-sm">Back</a>
                  <?php if ($mt_data->status == 'SUBMITTED') { ?>
                     <a href="/quotation/manage/edit/<?php echo $quotation_id; ?>" class="btn btn-warning btn-sm float-right">Edit Quotation</a>
                  <?php } ?>
               </div>
            </div>
         </div>
