...
<div class="content">
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            <input type="hidden" id="module" value="quotation" />
                  ...
                  <div class="row">
                     <div class="col-xl-4 col-md-6">
                        <a data-toggle="modal" data-target="#settingsModal">
                           Settings <span>Settings of Quotation Template</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a href="/quotation/create">
                           Create <span>Create quotation for any customer</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a href="/quotation/listing">
                           Listing <span>Submitted / Rejected / Sucessful / Deleted Quotations</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a href="/quotation/report_options">
                           Reports <span>Reports of Sales and Marketting</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a data-toggle="modal" data-target="#utilityModal">
                           Utilities > Datafiles<span>Backup / Restore / Zap of Quotation Datafile's</span>
                        </a>
                     </div>
                  </div>
               </div>
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      $('#settingsModal').on('shown.bs.modal', function() {
         $.post('/quotation/ajax/get_settings', {
         }, function (settings) {
      ...
      $(document).on("change", "#text_prefix, #number_suffix", function(e) {
         ...
         $.post('/quotation/ajax/double_quotation', {
            text_prefix: text_prefix, 
            number_suffix: number_suffix
         }, function(data) {
            if (data == 1) {
               same_reference_exists = 1;
               $('.suffix_error').text('Quotation reference ' + text_prefix + '.' + (parseInt(number_suffix) + 1) +' is already in the system, please change suffix number.');
               $('.suffix_error').show();
            } else {
      ...
      $('#btn_submit').click(function() {
         if(same_reference_exists == 0 && isFormValid()) {
            $.post('/quotation/ajax/save_settings', {
