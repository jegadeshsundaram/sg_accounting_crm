      ...
      <table style="width: 1000px;" align="center">
         <tr>
            ...
            <td valign="top" align="right">
               <br />
               <span style="font-size: 2rem; color: #434c5e;">QUOTATION<span> <br />

               <span style="width: 150px; font-weight: normal; letter-spacing: 5px; color: #FF43A4; padding-top: 5px; font-size: 1.2rem;"><?php echo $data['quotation_ref_no']; ?></span><br /><br />
