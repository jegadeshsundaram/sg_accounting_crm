<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0">Import <?php echo $title; ?></h1>
         </div>
         <div class="col-sm-6">
               ...
               <div class="card card-default">
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group row" style="margin-top: 30px; margin-bottom: 30px">
                        <div class="col-md-4">
                           <label id="upload-btn" for="db_file" class="btn btn-secondary btn-block">Upload <?php echo $title; ?>.DBF File</label>
                        </div>
                        <div class="col-md-8">
                  ...
                  <div class="card-footer">
                     <a href="/data_migration/options" class="btn btn-info">Cancel</a>          
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      $('#btn_submit').click(function() {
         if($('#form_').valid()) {
            $('#db_file-error').hide();
            $('#confirmSubmitModal .modal-title').html("<i class='fa fa-info'></i> DATA MIGRATION");
            $('#confirmSubmitModal .modal-body').html("<span style='color: red; font-size: 14px'><i>Please do backup before proceed.</i></span><br /><br /><span style='color: #000; font-size: 14px'>Process will over-write corresponding <?php echo $title; ?> Table in CRM System</span>");
