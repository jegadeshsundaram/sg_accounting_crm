...
<div class="content">
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            <input type="hidden" id="module" value="accounts_receivable" />
            <div class="card card-default">
               ...
               <div class="card-body opt-lnk">
                  <div class="row">
                     ...
                     <div class="col-xl-4 col-md-6">
                        <a href="/accounts_receivable/batch_ob_listing">
                           Opening Balance <span>Manage opening balance transactions</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a href="/accounts_receivable/reports">
                           Reports <span>Report of Debtors statement / Listing / Ageing</span>
                        </a>
                     </div>
                  ...
                  <div class="row" style="margin-bottom: 15px">
                     ...
                     <div class="col-md-12">
                        <select name="transaction" id="transaction" class="form-control">
                           ...
                           <option value="BTHREC">Batch Receipt</option>
                        </select>
   ...
   <div class="modal-dialog modal-confirm">
      <div class="modal-content">
         <form id="frm_dp" action="#" method="POST">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-header">
                  <span style="margin: 0; display: block;">AR Datapatch</span>
   ...
   $(function() {
      ...
      $('#btn_print').on('click', function() {
         if($('#transaction').val() == "") {
            ...
            var url = '/accounts_receivable/print_audit';
            ...
            $.confirm({
               ...
               buttons: {
                  yes: {
                     ...
                     action: function() {
                        var url = '/accounts_receivable/offset';
      ...
      $(document).on('change', '#customer', function() {
         ...
         if(code !== "") {
            $.post('/accounts_receivable/ajax/get_refs', {
               customer_code: code
            }, function (data) {
      ...
      $("#btn_data_patch").click(function() {
         if($('#customer').val() == '' && $('ref_no').val() == '') {
            return false;
         }

         $("#frm_dp").attr("action", '/accounts_receivable/data_patch');
