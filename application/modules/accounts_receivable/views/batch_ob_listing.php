      ...
      <div class="row buttons-panel">
         <div class="col-lg-12">
            <div class="card card-default">
               ...
               <div class="card-header">
                  <a href="/accounts_receivable/manage_batch_ob" class="btn btn-info btn-sm" style="margin-right: 10px;">
                  ...
                  <button class='btn btn-success btn-sm d-none' id='btn_post_all'>
                     <i class='fa-solid fa-check-double'></i> Post All
                  </button>
                  <button class='btn bg-maroon btn-sm' id='btn_delete'>
                     <i class='fa fa-trash'></i> Delete
                  </button>
                  <button class='btn bg-maroon btn-sm d-none' id='btn_delete_all'>
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      table = $('#dt_').DataTable({
         'processing': true,
         'ajax': {
            'url': '/accounts_receivable/ajax/populate_batch_ob',
            'type': 'post'
         },
         'columnDefs': [
            { 'width': 350, 'targets': 1 },
      ...
      table.column( 0 ).visible( false ); // id 
		...
		$("#btn_edit").on('click',function() {
         url = '/accounts_receivable/manage_batch_ob/';
         showData("edit", url);
		});

      $("#btn_delete").on('click',function() {
         url = '/accounts_receivable/ajax/delete';
         showData("delete", url);
		});
      ...
      $("#btn_post").on('click', function() {
         url = '/accounts_receivable/ajax/post';
      ...
      $("#btn_print").on('click', function() {
         url = '/accounts_receivable/print_batch_ob';
         showData("print", url);
      });

      $("#btn_print_all").click(function() {
         var url = '/accounts_receivable/print_batch_ob';
         print_all(url);
      });
