         ...
         <div class="col-lg-12">
            <div class="card card-default">
               <div class="card-header">
                  <h5>Reports</h5>
                  <a href="/accounts_receivable/" class="btn btn-outline-dark btn-sm float-right">
                  ...
                  <div class="row">
                     <div class="col-xl-4 col-md-6 mt-10">
                        <a data-toggle="modal" data-target="#statementModal" class="btn btn-info btn-block">
                           Current Statement <span>Statment of Current transactions can be printed for any Debtor</span>
                        </a>
                     </div>
                     <div class="col-xl-4 col-md-6 mt-10">
                        <a data-toggle="modal" data-target="#historicalStatementModal" class="btn btn-info btn-block">
                           Hisorical Statement <span>Statment of Historical transactions can be printed for any Debtor</span>
                        </a>
                     </div>
                     <div class="col-xl-4 col-md-6 mt-10">
               ...
               <div class="card-footer">
                  <a href="/accounts_receivable" class="btn btn-warning btn-sm float-right" style="font-size: 1rem">
      ...
      <div class="modal-content">
         <form id="frm_stmt" action="#" method="POST">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-header">
                  <span style="margin: 0; display: block;">Debtor Statement</span>
                  <span style="margin: 0;font-size: 0.7rem;"><strong>Note: </strong>Current Statement of the selected debtor will be printed in the pdf format</span>
   ...
   <div class="modal-dialog modal-confirm">
      <div class="modal-content">
         <form id="frm_hstl_stmt" action="#" method="POST">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-header">
                  <span class="float-left" style="margin: 0;">Historical Debtor Statement</span>
                  <span style="margin: 0;font-size: 0.7rem; float: left;"><strong>Note: </strong>Historical statement wil be printed for the selected debtor</span>
               ...
               <div class="card-body">                  
                  ...
                  <div class="row">
                     <label for="customer_id" class="col-md-12 control-label">Debtor : </label>
                     <div class="col-md-12">
   ...
   <div class="modal-dialog modal-confirm">
      <div class="modal-content">
         <form id="frm_lstng" action="#" method="POST">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-header">
                  <span style="margin: 0; display: block;">Debtor Listing</span>
...
<!-- Modal :: Historical Debtor Listing -->
   ...
   <div class="modal-dialog modal-confirm">
      <div class="modal-content">
         <form id="frm_hstl_lstng" action="#" method="POST">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-header">
                  <span class="float-left" style="margin: 0;">Historical Debtor Listing</span>
                  <span style="margin: 0;font-size: 0.7rem; float: left;"><strong>Note: </strong>Historical Listing wil be printed for the selected debtor</span>
   ...
   <div class="modal-dialog modal-confirm">
      <div class="modal-content">
         <form id="frm_agng" action="#" method="POST">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-header">
                  <span class="float-left" style="margin: 0;">Debtor's Ageing</span>
...
<script>
   ...
   $(function() {
      ...
      $("#btn_print_statement").click(function() {
         ...
         $("#frm_stmt").attr("action", '/accounts_receivable/print_statement');
      ...
      $('#btn_print_historical_statement').on('click', function() {
         ...
         var url = '/accounts_receivable/print_historical_statement';
      ...
      $("#btn_print_listing").click(function() {
         ...
         $("#frm_lstng").attr("action", '/accounts_receivable/print_listing');
      ...
      $('#btn_print_historical_listing').on('click', function() {
         ...
         var url = '/accounts_receivable/print_historical_listing';
      ...
      $('#btn_print_ageing').on('click', function() {
         ...
         var url = '/accounts_receivable/print_ageing';
