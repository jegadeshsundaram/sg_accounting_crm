$(function() { // document starts
   ...
   $("#customer_id").change(function() {
      ...
      $.post('/accounts_receivable/ajax/get_customer', {
         ...
         if(obj.customer_currency == "SGD") {
            ...
            $('.f_curr').html('('+obj.customer_currency+')');
   ...
   $(document).on("change", "#ref_no", function() {
      ...
      if(current_ref !== "") {
            ...
            $.post('/accounts_receivable/ajax/double_ob_ref', {
      ...
      $.confirm({
         ...
         buttons: {
            yes: {
               ...
               action: function() {
                  $.post('/accounts_receivable/ajax/delete_ob_entry', {
...
function save_entry() {
   ...
   $.post('/accounts_receivable/ajax/save_ob_entry', {
      ob_id: ob_id,
      customer_id: customer_id,
      doc_date: doc_date,
      ref_no: ref_no,
