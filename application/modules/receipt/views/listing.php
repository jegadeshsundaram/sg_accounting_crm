<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0"><span class="title"></span> Receipt's</h1>
         </div>
         <div class="col-sm-6">
      ...
      <div class="modal-content">
         <form id="form_1" method="get">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-header">
                  <span class="title" style="margin: 0;">Export Receipt to DBF</span> <br />
                  <span style="margin: 0; font-size: 0.7rem;"><strong>Note: </strong>All the confirmed Receipts will be exported into DBF file on submission</span>
   ...
   $(function() {
      ...
      $('#listing').change(function() {
         ...
         table = $('#dt_').DataTable({
            'processing': true,
            'ajax': {
               'url': '/receipt/datatable/ajax_list/'+type,
               'type': 'post'
            },
            'columnDefs': [
      ...
      $("#btn_view").on('click',function() {
			var url = '/receipt/manage/view/';
			showData("view", url);
		});

		$("#btn_edit").on('click',function() {
			var url = '/receipt/manage/edit/';
			showData("edit", url);
		});

      $("#btn_delete").on('click',function() {
			var url = '/receipt/ajax/delete';
			showData("delete", url);
		});

      $("#btn_email").click(function() {
         url = '/receipt/print_stage_2';
         showData("email", url);
      });

      $("#btn_post").on('click', function() {
         var url = '/receipt/ajax/post';
      ...
      $("#btn_print_all").click(function() {
         url = '/receipt/print_receipts/'+$("#listing").val();
         print_all(url);
      });
      ...
      $("#btn_export_modal_submit").on('click', function() {
         if($('#from_date').val() == "") {
            ...
            $.confirm({
               ...
               content: 'Are you sure to Export confirmed Receipts into DBF ?',
               buttons: {
                  yes: {
                     ...
                     action: function() {
                        ...
                        var url = '/system_utilities/export_receipts/'+start_date+'/'+end_date;
