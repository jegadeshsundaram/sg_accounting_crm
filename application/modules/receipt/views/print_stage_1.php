<body style="font-family: sans-serif; font-size: 12pt;">
   ...
   <div style="width: 100%;">
      ...
      <table width="98%" align="center">
         <tr>
            ...
            <td valign="bottom" align="right">
               <span style="font-size: 1rem; color: dimgray;">RECEIPT #<span> <br />

               <span style="width: 150px; font-weight: normal; letter-spacing: 1px; color: #FF43A4; padding-top: 5px; font-size: 1rem;"><?php echo $receipt_ref_no; ?></span><br /><br />
               ...
               <div style="width: 150px; padding: 10px; font-weight: normal; color: dimgray; border-bottom: 1px solid #ccc; font-size: 1rem;">
                  ...
                  <span style="padding: 10px; border-top: 1px solid #ccc; letter-spacing: 1px; color: #000; background: #f5f5f5;">
                     <?php echo strtoupper(date('M j, Y', strtotime($data['created_on']))); ?>
                  </span>
               </div>
            </td>
         </tr>
         ...
         <tr>
            <td width="62%">
               ...
               <table style="margin-top: 5px;">
                  <tr>
                     <td>
                        <strong><?php echo $customer_name; ?> (<?php echo $customer_code; ?>)</strong>
                     </td>
                  </tr>
                  <tr>
                     <td style="margin-top: 5px;">
                        <?php echo $customer_address; ?> <br /><br />
                     </td>
                  </tr>
               </table>
            </td>
            <td width="38%">
               ...
               <table align="right">
                  <tr>
                     ...
                     <td><?php echo $this->data['data']['bank']; ?></td>
                  </tr>
                  <tr>
                     <td height="25"><strong>Cheque No:</strong></td>
                     <td><?php echo $this->data['data']['cheque']; ?></td>
                  </tr>
                  <tr>
                     <td height="25"><strong>Amount:</strong></td>
                     <td><span style="color: red"><?php echo $customer_currency; ?></span> <?php echo number_format($this->data['data']['amount'], 2); ?> CR</td>
                  </tr>
               </table>
            </td>
         </tr>
      ...
      <table align="center" style="width: 400px; border-collapse: collapse">
         <tr>
            <td>Settlement details as follows :</td>
         </tr>
      </table>
      <br />
      ...
      <table width="98%" align="center">
         <tr>
            <td><strong>Remarks:</strong><br /> <?php echo $other_reference; ?></td>
         </tr>
      </table>
