      ...
      <table width="98%" align="center">
         <tr>
            ...
            <td valign="bottom" align="right">
               ...
               <span style="width: 150px; font-weight: normal; letter-spacing: 1px; color: #FF43A4; padding-top: 5px; font-size: 1rem;"><?php echo $mt_data->receipt_ref_no; ?></span><br /><br />
         ...
         <tr>
            <td width="62%">
               ...
               <table style="margin-top: 5px;">
                  <tr>
                     <td>
                        <strong><?php echo $customer_name_code; ?></strong>
                     </td>
                  </tr>
                  <tr>
            ...
            <td width="38%">
               ...
               <table align="right">
                  ...
                  <tr>
                     ...
                     <td><span style="color: red"><?php echo $mt_data->currency; ?></span> <?php echo number_format($mt_data->amount, 2); ?> CR</td>
                  </tr>
               </table>
            </td>
         </tr>
