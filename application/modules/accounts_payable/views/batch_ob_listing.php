      ...
      <div class="row buttons-panel">
         <div class="col-lg-12">
            <div class="card card-default">
               ...
               <div class="card-header">
                  <a href="/accounts_payable/manage_batch_ob" class="btn btn-info btn-sm" style="margin-right: 10px;">
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      table = $('#dt_').DataTable({
         'processing': true,
         'ajax': {
            'url': '/accounts_payable/ajax/populate_batch_ob',
            'type': 'post'
         },
         'columnDefs': [
            { 'width': 350, 'targets': 1 },
      ...
      table.column( 0 ).visible( false ); // id 
		...
		$("#btn_edit").on('click',function() {
         url = '/accounts_payable/manage_batch_ob/';
         showData("edit", url);
		});

      $("#btn_delete").on('click',function() {
         url = '/accounts_payable/ajax/delete';
         showData("delete", url);
		});
      ...
      $("#btn_post").on('click', function() {
         url = '/accounts_payable/ajax/post';
      ...
      $("#btn_print").on('click', function() {
         url = '/accounts_payable/print_batch_ob';
         showData("print", url);
      });

      $("#btn_print_all").click(function() {
         var url = '/accounts_payable/print_batch_ob';
         print_all(url);
      });
