            ...
            <form autocomplete="off" id="form_" method="post" action="<?php echo $save_url; ?>">
               <div class="card card-default">
                  <div class="card-header">
                     ...
                     <a href="/accounts_payable/batch_ob_listing" class="btn btn-outline-secondary btn-sm float-right">Back</a>
                  </div>
                  <div class="card-body">
                     <div class="row">
                        <div class="col-md-4">
                           ...
                           <table id="tbl_items" class="table table-custom" style="min-width: 1400px; width: 100%; display: <?php echo $page == 'edit' ? 'inline-table' : 'none'; ?>">
                              ...
                              <?php
                                 if ($page == 'edit') {
                                    ...
                                    $this->db->where(['supplier_id' => $supplier_id, 'status' => 'C']);
                                    $query = $this->db->get();
                  ...
                  <div class="card-footer">
                     <a href="/accounts_payable/batch_ob_listing" class="btn btn-info btn-sm">Cancel</a>                  
...
<script type="text/javascript" src="/application/modules/accounts_payable/js/ob_process.js"></script>
