      ...
      <div class="row buttons-panel">
         <div class="col-lg-12">
            <div class="card card-default">
               ...
               <div class="card-header">
                  <a href="/stock/manage_purchase" class="btn btn-info btn-sm">
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      table = $('#dt_').DataTable({
         'processing': true,
         'ajax': {
            'url': '/stock/ajax/populate_purchase',
            'type': 'post'
         },
         'columnDefs': [
            { 'width': 100, 'targets': 1 },
      ...
      table.column( 0 ).visible( false ); // id
		...
		$("#btn_edit").on('click',function() {
         url = '/stock/manage_purchase/';
         showData("edit", url);
		});

      $("#btn_delete").on('click',function() {
         url = '/stock/ajax/delete_purchase';
         showData("delete", url);
		});
