      ...
      <div class="row mb-2">
         ...
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item">Goods Received</li>
            </ol>
         </div>
      </div>
   </div>
            ...
            <form autocomplete="off" id="form_" method="post" action="<?php echo $save_url; ?>">
               <div class="card card-default">
                  <div class="card-header">
                     <h5>Input Goods Received</h5>
                     <a href="/stock/purchase" class="btn btn-outline-dark btn-sm float-right">
                  ...
                  <div class="card-body">
                     ...
                     <div class="row form-group">
                        <label class="control-label col-md-3">Supplier : </label><br />
                        <div class="col-md-3">
                           ...
                           <table id="tbl_items" class="table table-custom" style="min-width: 1000px; width: 100%; display: <?php echo $page == 'edit' ? 'inline-table' : 'none'; ?>">
                              ...
                              <tbody>
                                 ...
                                 if ($page == 'edit') {
                                    ...
                                    $this->db->where(['document_date' => $doc_date, 'document_reference' => $ref_no, 'supplier_id' => $supplier_id, 'status' => 'C']);
                                 ...
                                 <tr id="<?php echo $i; ?>">
                                    <td>
                                       ...
                                       <input 
                                          type="hidden" 
                                          id="purchase_id_<?php echo $i; ?>" name="purchase_id[]" 
                                          value="<?php echo $value->purchase_id; ?>" 
                                          class="purchase_id" />
                  ...
                  <div class="card-footer">
                     <a href="/stock/purchase" class="btn btn-info btn-sm">Cancel</a>                  
   ...
   <tbody>
      <tr id="0">
         <td>
            <input 
               type="hidden" 
               id="purchase_id_0" name="purchase_id[]" class="purchase_id" />
...
<script type="text/javascript" src="/application/modules/stock/js/pr_process.js"></script>
