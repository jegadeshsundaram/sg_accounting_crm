            ...
            <form autocomplete="off" id="form_" method="post" action="<?php echo $save_url; ?>">
               <div class="card card-default">
                  <div class="card-header">
                     ...
                     <a href="/stock/opening_balance" class="btn btn-outline-secondary btn-sm float-right">Back</a>
                  </div>
                  <div class="card-body">
                           ...
                           <table id="tbl_items" class="table table-custom" style="min-width: 1000px; width: 100%; display: <?php echo $page == 'edit' ? 'inline-table' : 'none'; ?>">
                              <thead>
                                 <tr>
                                    ...
                                    <th class="w-110">UOM</th>
                                    <th class="w-140">Quantity</th>
                                    <th class="w-180">Unit Cost</th>
                                    <th>Remarks</th>
                                 </tr>
                              </thead>
                              <tbody>
                                 ...
                                 <tr id="<?php echo $i; ?>">
                                    <td>
                                       <input 
                                          ...
                                          value="<?php echo $value->stock_ob_id; ?>"
                                          class="ob_id" />
                                    ...
                                    <td>
                                       <?php $uom = $this->custom->getSingleValue('master_billing', 'billing_uom', ['billing_id' => $value->product_id]); ?>
                                       <input 
                  ...
                  <div class="card-footer">
                     <a href="/stock/opening_balance" class="btn btn-info btn-sm">Cancel</a>                  
...
<script type="text/javascript" src="/application/modules/stock/js/ob_process.js"></script>
