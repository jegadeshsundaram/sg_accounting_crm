                  ...
                  <div class="card-body">
                     <div class="row">
                        <div class="col-lg-12">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                 <input 
                                    ...
                                    name="code" id="code" 
                                    maxlength="10"
                                    class="form-control w-150 code req" required />
                           ...
                           <!-- Field: Department -->
                           <div class="form-group row">
                              <label for="department" class="col-md-4 control-label txt-right">Department :</label>
                              <div class="col-md-8">
...
<script type="text/javascript">
   ...
   $(function() {      
      ...
      $("#btn_submit").click(function(event) {
         ...
         var update_url = "/master_files/Ajax/employee/save";
