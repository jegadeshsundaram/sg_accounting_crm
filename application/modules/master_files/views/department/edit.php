      ...
      <div class="row">
         <div class="col-lg-12">
            <form autocomplete="off" id="form_" method="post" action="#">
               <input name="id" id="department_id" value="<?php echo $department_data->d_id; ?>" type="hidden" />
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                 <input 
                                    type="text" 
                                    name="code" id="code" 
                                    value="<?php echo $department_data->code; ?>" 
                                    maxlength="12"
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                 <input 
                                    type="text" 
                                    name="name" id="name" 
                                    value="<?php echo $department_data->name; ?>" 
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      if (window.location.href.indexOf("view_department") > -1) {
      ...
      // System checks whether this department is already used in Employee Master
      // If Yes, then code input will be disabled
      // If No, then code input will be enabled and User can do edit if needed
      code = $('#code').val();
      $.post('/master_files/ajax/consultDepartment', {
      ...
      $('#btn_submit').click(function() {
         ...
         var url = "/master_files/Ajax/department/update";
