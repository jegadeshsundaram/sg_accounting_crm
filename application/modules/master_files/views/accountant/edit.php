      ...
      <div class="row">
         <div class="col-lg-12">
            <form autocomplete="off" id="form_" method="post" action="#">
               <input name="id" value="<?php echo $accountant->ac_id; ?>" type="hidden" />
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-8">
                           <input 
                              type="text" 
                              name="code" id="code" 
                              value="<?php echo $accountant->code; ?>"
                              maxlength="12"
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-8">
                           <input 
                              type="text" 
                              name="name" id="name" 
                              value="<?php echo $accountant->name; ?>" 
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-8">
                           <input 
                              type="email" 
                              name="email" id="email" 
                              value="<?php echo $accountant->email; ?>" 
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-8">
                           <input 
                              ...
                              value="<?php echo $accountant->category; ?>" 
                              class="form-control w-300 req" required />
                        </div>
                     </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-8">
                           <input 
                              ...
                              value="<?php echo $accountant->basic_salary; ?>" 
                              class="form-control w-150 req" required />
                        </div>
                     </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-8">
                           <input 
                              ...
                              maxlength="5"
                              value="<?php echo $accountant->incentives; ?>"
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      if (window.location.href.indexOf("view_accountant") > -1) {
      ...
      $.post('/master_files/ajax/consultAccountant', {
         code: code,
      }, function (data) {
         if(data == 1) {
      ...
      $('#btn_submit').click(function() {
         ...
         var url = "/master_files/Ajax/accountant/update";
