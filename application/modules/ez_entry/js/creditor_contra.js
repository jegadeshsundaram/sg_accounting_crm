...
$(function() {
    ...
    $("#supplier").change(function(event) {
        ...
        if (id !== "") {
            $.post('/ez_entry/ajax/get_supplier_debits_credits', {
                supplier_id: id
            }, function (data) {
    ...
    $('#btn_submit').on('click', function() {
        var url = '/ez_entry/save_creditor_contra';
        $('#ap_ids').val(contra_transaction_ids);
        if($('#ap_ids').val() == "") {
            alert("No entries selected");
        } else {
  
            console.log("Entries Selected :: "+$('#ap_ids').val());
            ...
            $('#ap_ids').val(removeDuplicates(contra_transaction_ids));
            console.log("Entries Selected :: "+$('#ap_ids').val());
