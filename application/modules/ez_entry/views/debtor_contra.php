            ...
            <div class="col-lg-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        ...
                        <a href="/ez_entry/debtor" class="btn btn-outline-secondary btn-sm float-right">Back</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
...
<script type="text/javascript" src="/application/modules/ez_entry/js/debtor_contra.js"></script>
<style>
    .select2-container {
        width: 100% !important;
    }
