      ...
      <div class="row mb-2">
         ...
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active">Credit Purchase</li>
            </ol>
         </div>
      </div>
   </div>
            ...
            <div class="card card-default">
               ...
               <div class="card-header">
                  <button class='btn btn-primary btn-sm' id='btn_new'>
                     <i class="fa fa-plus-circle" aria-hidden="true"></i> New Purchase
                  </button>
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      table = $('#dt_batch').DataTable({
         'processing': true,
         'ajax': {
            'url': '/ez_entry/datatable/ajax_list/batch_purchase',
            'type': 'post'
         },
         'columnDefs': [
            { 'width': 150, 'targets': 1 },
      ...
      $("#btn_new").on('click', function() {
         window.location.href = "/ez_entry/manage_purchase_batch/";
      });
      ...
      $("#btn_delete_all").on('click',function() {
         if(table.rows().eq(0).length > 0) {
            ...
            url = '/ez_entry/ajax/delete_purchase';
      ...
      $("#btn_post_all").on('click', function() {
         if(table.rows().eq(0).length > 0) {
            ...
            url = '/ez_entry/ajax/post_purchase';
      ...
      $("#btn_print_detailed").on('click', function() {
         if(table.rows().eq(0).length > 0) {
            url = '/ez_entry/print_purchase_audit_detailed';
            print_all(url);
         }
      });
      ...
      $("#btn_print_summary").click(function() {
         if(table.rows().eq(0).length > 0) {
            url = '/ez_entry/print_purchase_audit_summary';
            print_all(url);
         }
      });
      ...
      $('#dt_batch').on('click', 'tbody .dt_edit', function () {
         ...
         window.location.href = '/ez_entry/manage_purchase_batch/'+rowID;
      });
         ...
         $.confirm({
            ...
            buttons: {
               yes: {
                  ...
                  action: function() {
                     $.post('/ez_entry/ajax/delete_purchase', {
                        rowID: rowID
                     }, function (res) {
                        if(res == "error") {
