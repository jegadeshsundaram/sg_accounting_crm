         ...
         <div class="col-lg-12">
            <div class="card card-default">
               <div class="card-header">
                  <h5 style="float: left; margin-top: 8px;">Creditor</h5>
...
<!-- Creditor Statement Print - Modal -->
<div id="creditorModal" class="modal fade" data-backdrop="static">
         ...
         <form id="frm_" method="GET">
            <div class="card card-default" style="margin-bottom: 0rem;">
               <div class="card-body">
                  <div class="row mt-10">
                     <div class="col-12">
                        <label class="control-label">Supplier<span class="cl-red">*</span></label><br />
               ...
               <div class="card-footer">
                  <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#creditorModal">Cancel</button>
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      table = $('#dt_batch').DataTable({
         'processing': true,
         'ajax': {
            'url': '/ez_entry/datatable/ajax_list/creditor',
            'type': 'post'
         },
         'columnDefs': [
            { 'width': 140, 'targets': 1 },
      ...
      $('#creditorModal select').select2();

      $("#btn_process_contra").on('click', function() {
         window.location.href = "/ez_entry/creditor_contra";
      });
      ...
      $("#btn_delete_all").on('click',function() {
         if(table.rows().eq(0).length > 0) {
            ...
            url = '/ez_entry/ajax/delete_creditor_contra';
      ...
      $("#btn_post_all").on('click', function() {
         if(table.rows().eq(0).length > 0) {
            ...
            url = '/ez_entry/ajax/post_creditor_contra';
      ...
      $("#btn_print").on('click', function() {
         if($('#supplier').val() == "") {
            ...
            $("#frm_").attr("action", '/ez_entry/print_creditor');
      ...
      $('#dt_batch').on('click', 'tbody .dt_delete', function () {
         ...
         $.confirm({
            title: '<i class="fa fa-info"></i> Delete Creditor',
            content: 'Are you sure to delete?',
            buttons: {
            yes: {
               btnClass: 'btn-warning',
               action: function() {
                     $.post('/ez_entry/ajax/delete_creditor_contra', {
                        rowID: rowID
                     }, function (res) {
                        if(res == "error") {
