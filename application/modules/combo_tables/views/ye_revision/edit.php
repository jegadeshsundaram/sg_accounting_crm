      ...
      <div class="row">
         <div class="col-lg-12">
            <form autocomplete="off" id="form_" method="post" action="#">
               <input name="id" value="<?php echo $revision_data->r_id; ?>" type="hidden" />
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                 <input 
                                    ...
                                    value="<?php echo date('d-m-Y', strtotime($revision_data->cutoff_date)); ?>"
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                 <input 
                                    type="number" 
                                    name="rate" id="rate" 
                                    value="<?php echo $revision_data->rate; ?>"
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      if (window.location.href.indexOf("view_ye_revision") > -1) {
      ...
      $('#currency_rate').focusout(function() {
       ...
       $('#btn_submit').click(function() {
         if($('#form_').valid()) {
            ...
            $('#confirmSubmitModal .modal-body').html("Click 'Update' to save this currency...");
      ...
      $('#btn-confirm-yes').click(function() {
         ...
         var url = "/combo_tables/Ajax/YE_revision/update";
