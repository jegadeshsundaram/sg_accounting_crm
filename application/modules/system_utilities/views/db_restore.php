            ...
            <form id="form_" method="post" enctype="multipart/form-data" action="<?php echo $save_url; ?>">
               <div class="card card-default">
                  ...
                  <div class="card-footer">
                     <a href="/system_utilities/db_options" class="btn btn-info">Cancel</a>
   ...
   $(document).ready(function() {
      ...
      $('#btn_submit').click(function() {
         if($('#form_').valid()) {
            ...
            $('#confirmSubmitModal .modal-body').html("Please do backup before proceed to restore.<br />Restore will overwrite all data files in CRM System");
