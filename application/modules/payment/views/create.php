...
<div class="content">
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            <input type="hidden" id="redirect_url" value="/payment" />
            ...
            <form autocomplete="off" id="form_" method="post" action="<?php echo $save_url; ?>">
               ...
               <div class="card card-default">
                  <div class="card-header">
                     <span class="float-left"><?php echo $ref_no; ?></span>
                     <a href="/payment" class="btn btn-info btn-sm float-right">Back</a>
                  </div>
                  <div class="card-body">
                     ...
                     <div class="row">
                        <div class="col-md-5">
                           ...
                           <label for="supplier_id" class="control-label f-bold">To,</label><br />
                           <select name="supplier_id" id="supplier_id" class="form-control req" required>
                              <?php echo $supplier_options; ?>
                           </select>
                           <br />

                           <!-- Display supplier details upon selection -->
                           <div class="dsply_supplier_details" style="display: none;">
                           </div>
                        </div>
                        ...
                        <div class="col-md-4" style="margin-top: 20px">
                           <div class="form-group row">
                              <label for="created_on" class="col-md-4 control-label req">Date : </label>
                              <div class="col-md-8">
                                 <input 
                                    type="text"
                     ...
                     <div class="row">
                        <div class="col-md-10" style="margin: 15px 0 30px">
                           ...
                           <textarea id="other_reference" name="other_reference" class="form-control" placeholder="Optional! Remarks about the payment"></textarea>
                        </div>
                     ...
                     <div class="row" id="dv_contra" style="display: none">
                        <div class="col-md-12 table-responsive" style="margin: 15px 0 30px">
                           ...
                           <table id="tbl_contra" class="tbl-main" align="center" style="width: 600px; margin-top: 10px;">
                              <thead>
                                 <tr>
                                    <th class="header" colspan="4">Contra Payment</th>
                                 </tr>
                                 <tr>
                  ...
                  <div class="card-footer">
                     <button type="button" id="btn_print" class="btn btn-secondary btn-sm">Print Payment</button>
   ...
   <div class="modal-dialog modal-confirm">
      <div class="modal-content">
         <div class="modal-header">
            <h3 class="modal-title" style="text-align: center">Confirm Bank & Submit Payment</h3>
         </div>
         ...
         <div class="modal-footer justify-content-between">
            <button type="button" id="btn-cancel-payment" class="btn btn-info btn-sm">Cancel</button>
            <button type="button" id="btn-submit-payment" class="btn btn-warning btn-sm float-right">Submit Payment</button>
         </div>
      </div>
   </div>
</div>
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      $.post('/payment/ajax/double_reference', {
      ...
      $("#supplier_id").change(function () {
         ...
         if (supplier_id !== "") {
            $.post('/payment/ajax/get_payment_details', {
               ...
               $(".dsply_supplier_details").html(obj.supplier_address);
               $(".dsply_supplier_details").show();

               // hidden fields
               $('#currency').val(obj.supplier_currency);
            ...
            // address details, phone, email & currency
            $(".dsply_supplier_details").html('');
            $(".dsply_supplier_details").hide();
         }
      });
      ...
      var save_form_action = '/payment/create';
      var print_form_action = '/payment/print_stage_1';

      $("#btn_print").on('click', function() {
         $('#ap_ids').val(contra_transaction_ids);
      ...
      $('#btn-submit-payment').click(function() {
         if($("#bank_accn").val() == "") {
            ...
            $.post('/payment/ajax/double_payment', {
               ref_no: $('#ref_no').val()
            }, function (ref_no) {
               $('#ref_no').val(ref_no.trim());
   ...
   function calculate_final_balance() {
      ...
      if (final_balance == 0) {
         ...
         // this is to split only entry which has balance when inserting into AP TBL
         var last_entry_id = $('#tbl_contra tbody tr:last').attr('id');
         var arr = last_entry_id.split('_');
         var ap_id = arr[2];
         $('#final_balance_entry_id').val(ap_id);
   ...
   function add_payment_entry() {
      ...
      add_entry_to_contra(entry_id, entry_date, "dr_entry", ref_no, entry_amount, "", "1");
   }
