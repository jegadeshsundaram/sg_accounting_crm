...
<div class="content">
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            <input type="hidden" id="module" value="payment" />
                  ...
                  <div class="row">
                     <div class="col-xl-4 col-md-6">
                        <a data-toggle="modal" data-target="#settingsModal">
                           Settings <span>Settings of Payment Template</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a href="/payment/create">
                           Create <span>Create Payment for any supplier</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a href="/payment/listing">
                           Listing <span>Confirmed / Posted / Deleted Payments</span>
                        </a>
                     </div>

                     <div class="col-xl-4 col-md-6">
                        <a data-toggle="modal" data-target="#utilityModal">
                           Utilities > Datafiles<span>Backup / Restore / Zap of Payment Datafile's</span>
                        </a>
                     </div>
                  </div>
               </div>
...
<script type="text/javascript">
   ...
   $(function() {
      ...
      $('#settingsModal').on('shown.bs.modal', function() {
         $.post('/payment/ajax/get_settings', {
         }, function (settings) {
      ...
      $(document).on("change", "#text_prefix, #number_suffix", function(e) {
         ...
         $.post('/payment/ajax/double_payment', {
            ...
            if (data == 1) {
               ...
               $('.suffix_error').text('Payment reference ' + text_prefix + '.' + (parseInt(number_suffix) + 1) +' is already in the system, please change suffix number.');
               $('.suffix_error').show();
            } else {
      ...
      $('#btn_submit').click(function() {
         if(same_reference_exists == 0 && isFormValid()) {
            $.post('/payment/ajax/save_settings', {
