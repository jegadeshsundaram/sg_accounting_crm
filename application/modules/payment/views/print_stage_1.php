      ...
      <table width="98%" align="center">
         <tr>
            ...
            <td valign="bottom" align="right">
               ...
               <span style="width: 150px; font-weight: normal; letter-spacing: 1px; color: #FF43A4; padding-top: 5px; font-size: 1rem;"><?php echo $document_reference; ?></span><br /><br />
         ...
         <tr>
            <td width="62%">
               ...
               <table style="margin-top: 5px;">
                  <tr>
                     <td>
                        <strong><?php echo $supplier_name; ?> (<?php echo $supplier_code; ?>)</strong>
                     </td>
                  </tr>
                  <tr>
            ...
            <td width="38%">
               ...
               <table align="right">
                  ...
                  <tr>
                     ...
                     <td><span style="color: red"><?php echo $supplier_currency; ?></span> <?php echo number_format($this->data['data']['amount'], 2); ?> DR</td>
                  </tr>
               </table>
            </td>
         </tr>
