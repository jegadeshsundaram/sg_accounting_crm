               ...
               <div class="card card-default">
                  ...
                  <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="row form-group">
                              <label for="pay_to" class="col-md-4 control-label">Date : </label>
                              <div class="col-md-8">
                                 <input 
                                    type="text"
                                    id="doc_date" name="doc_date"
                                    class="form-control dp_full_date w-120" 
                                    value="<?php echo $page == 'edit' ? date('d-m-Y', strtotime($doc_date)) : date('d-m-Y'); ?>" />
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-md-12 table-responsive">
                           <table id="tbl_items" class="table table-custom" style="min-width: 1400px; width: 100%; display: <?php echo $page == 'edit' ? 'inline-table' : 'none'; ?>">
                              <thead>
                                 <tr>
                                    <th class="w-140">Action</th>
                                    <th class="w-350">Chart Of Account</th>
                                    <th class="w-350 ca_row" style="display: <?php echo $ca_len > 0 ? 'block' : 'none'; ?>">Control Account</th>
                              ...
                              <tbody>
                                ...
                                if ($page == 'edit') {
                                    ...
                                    $this->db->where(['ref_no' => $pc_voucher_number, 'status' => 'C']);
                                    $query = $this->db->get();
                                ...
                                <tr id="<?php echo $i; ?>">
                                    ...
                                    <td>
                                        <?php $coa_desc = $this->custom->getSingleValue('chart_of_account', 'description', ['accn' => $value->accn]); ?>
                                        <input 
                                            type="text" 
                                            id="coa_desc_<?php echo $i; ?>" 
                                            value="<?php echo $value->accn.' : '.$coa_desc; ?>"
                                    ...
                                    <td class="ca_row" style="display: <?php echo $ca_len > 0 ? 'block' : 'none'; ?>">
                                       <?php 
                                          $iden_details = '';
                                          if($value->accn == "CA001") {
                                             $name = $this->custom->getSingleValue('master_customer', 'name', ['code' => $value->iden]);
                                             $iden_details = $name.' ( '.$value->iden.' ) ';
                                          } else if($value->accn == "CL001") {
                                             $name = $this->custom->getSingleValue('master_supplier', 'name', ['code' => $value->iden]);
                                             $iden_details = $name.' ( '.$value->iden.' ) ';
                                          }
                                       ?>
                                        <input 
                                        type="text" id="iden_details_<?php echo $i; ?>"
                                        value="<?php echo $iden_details; ?>"
                                        class="form-control iden_details" readonly />
                                        
                                        <input type="hidden" id="iden_<?php echo $i; ?>" name="iden[]" value="<?php echo $value->iden; ?>" class="iden" />
                                        <input type="hidden" id="gst_type_<?php echo $i; ?>" name="gst_type[]" value="<?php echo $value->gst_type; ?>" class="gst_type" />
                                        <input type="hidden" id="gst_category_<?php echo $i; ?>" name="gst_category[]" value="<?php echo $value->gst_category; ?>" class="gst_category" />
                                        <input type="hidden" id="net_amount_<?php echo $i; ?>" name="net_amount[]" value="<?php echo $value->net_amount; ?>" class="net_amount" />
                                        <input type="hidden" id="gst_amount_<?php echo $i; ?>" name="gst_amount[]" value="<?php echo $value->gst_amount; ?>" class="gst_amount" />
                                    </td>
                              ...
                              <tfoot>
                                 <tr>
                                    <td></td>
                                    <td class="ca_row" style="display: <?php echo $ca_len > 0 ? 'block' : 'none'; ?>"></td>
                     ...
                     <div class="row ft_input" style="display: <?php echo $page == 'edit' ? 'flex' : 'none'; ?>">
            ...
            <div class="card-body">
               ...
               <div class="row mt-10 gst_field" style="display: none">
                  <div class="col-12">
                     ...
                     <input type="hidden" id="gst_type" value="" />
                  </div>
               </div>
...
<script type="text/javascript">
   ...
   function manage_entry() {
      ...
      if($("#coa").val() !== "CL300") {
         $row.find('input.gst_category').val('');
      }      
