...
<div id="creditModal" class="modal fade" data-backdrop="static">
   <div class="modal-dialog modal-confirm" style="max-width: 400px;">
      <div class="modal-content">
         <div class="card card-default" style="margin-bottom: 0rem;">
            <div class="card-header">
               <span class="float-left" style="margin: 0;">Credit Limit</span>
               <span style="margin: 0;font-size: 0.7rem; float: left;"><strong>Note: </strong>Credit Limit of the selected customer will display here.</span>
               <button type="button" class="btn btn-outline-dark btn-sm float-right" style="position: absolute;top: 20px;right: 20px;" data-toggle="modal" data-target="#creditModal"><i class="fa-solid fa-xmark"></i></button>
            </div>
            <div class="card-body">
               <div class="row" style="margin-bottom: 15px">
                  <label class="col-5 control-label float-right">Credit Terms : </label>
                  <div class="col-7" style="padding-top: 10px">
                     <span class="credit_terms"></span>
                  </div>
               </div>
               <div class="row" style="margin-bottom: 15px">
                  <label class="col-5 control-label float-right">Credit Limit : </label>
                  <div class="col-7" style="padding-top: 10px">
                     <span class="credit_limit"></span>
                  </div>
               </div>
               <div class="row" style="margin-bottom: 15px">
                  <label class="col-5 control-label float-right">Amount Utilized : </label>
                  <div class="col-7" style="padding-top: 10px">
                     <span class="amount_utilized"></span>
                  </div>
               </div>
               <div class="row" style="margin-bottom: 15px">
                  <label class="col-5 control-label float-right">Amount Available : </label>
                  <div class="col-7" style="padding-top: 10px">
                     <span class="amount_available"></span>
                  </div>
               </div>
            </div>
            <div class="card-footer">
               <button type="button" id="btn-credit-abort" class="btn btn-info btn-sm">Abort</button>
               <button type="button" id="btn-credit-proceed" class="btn btn-danger btn-sm float-right">Proceed</button>
            </div>
         </div>
      </div>
   </div>
