<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0">Customer Price - Add</h1>
         </div>
         <div class="col-sm-6">
                              ...
                              <tbody>
                                 <tr id="0">
                                    <td style="width: 400px">
                                       <select id="product_id_0" name="product_id[]" class="form-control ddm_product" required>
                                          <option value="">Select Product</option>
                                       </select>
                                    </td>
                                    <td style="width: 90px">
                                       <input type="text" id="uom_0" class="form-control" readonly />
                                    </td>
                                    <td style="width: 170px">
                                       <input type="number" id="unit_cost_0" name="unit_cost[]" class="form-control inp_unit_cost" required />
                                    </td>
                                    <td>
...
<script>
   ...
   $(function() {
      ...
      $.post('/invoice/customer_special_price/get_billings', {
         product: 'Y',
         service: 'N'
      }, function(data) {
         var obj = $.parseJSON(data);
         if(obj.product_service_options !== "") {
            $("#product_id_0").append(obj.product_service_options);
         }
      });
