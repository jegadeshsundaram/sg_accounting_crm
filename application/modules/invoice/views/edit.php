         ...
         <div class="col-lg-12">
            ...
            <form autocomplete="off" id="form_" method="post">
               ...
               <input
                  ...
                  value="<?php echo $mt_data->invoice_ref_no; ?>" />
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-5" style="margin-top: 20px">
                           ...
                           <?php if ($mt_data->quotation_ref_no !== null) { ?>
                              <div class="form-group row">
                                 <label for="quotation_ref_no" class="col-md-4 control-label">Cross Reference : </label>
                                 <div class="col-md-8">
                                    <input type="hidden" name="quotation_ref_no" value="<?php echo $mt_data->quotation_ref_no; ?>" />
                                    <span style="display: block; padding-top: 10px; color: dimgray; letter-spacing: 1px;"><?php echo $mt_data->quotation_ref_no; ?></span>
                                 </div>
                              </div>
                           <?php } ?>
                        </div>
                ...
                ?>
                     ...
                     <div class="row">
                        <div class="col-md-12" style="margin: 15px 0 30px">
                           ...
                           <textarea id="payment_terms" name="payment_terms" class="form-control" placeholder="Optional!"><?php echo $mt_data->payment_terms; ?></textarea>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-md-12" style="margin: 15px 0 30px">
                           ...
                           <textarea id="order_notes" name="order_notes" class="form-control" placeholder="Optional!"><?php echo $mt_data->order_notes; ?></textarea>
                        </div>
                     </div>
                  ...
                  <div class="card-footer btns">
                     <a href="/invoice/listing" class="btn btn-info btn-sm">EXIT</a>
...
<script type="text/javascript" src="/application/modules/invoice/js/process.js"></script>
