...
<body>
   <?php $document_date = strtoupper(date('M j, Y', strtotime($data['created_on']))); ?>
      ...
      <table style="width: 1000px;" align="center">
         <tr>
            ...
            <td valign="top" align="right">
               ...
               <span style="width: 150px; font-weight: normal; letter-spacing: 5px; color: #FF43A4; padding-top: 5px; font-size: 1.2rem;"><?php echo $data['invoice_ref_no']; ?></span><br /><br />
   ...
   if ($data['quotation_ref_no'] != '') { ?>
               <br /><br />
               <u>Cross Reference</u>: <?php echo $data['quotation_ref_no']; ?>
               <?php } ?>
            </td>
         </tr>
      </table>
      ...
      <!-- header information -->
      <?php if ($data['header_notes'] !== '') { ?>
         <table style="width: 1000px; background: #f5f5f5;" align="center">
            <tr>
               <td style="text-align: center">
                  <span style="font-family: cursive; color: #C62168; font-style: italic;"><?php echo $data['header_notes']; ?></span>
               </td>
            </tr>
         </table>
      <?php } ?>
   ...
   for ($i = 0; $i <= $total_items - 1; ++$i) {
       $billing_data = $this->custom->getSingleRow('master_billing', ['billing_id' => $data['billing_id'][$i]]); ?> ?>
            <tr style="page-break-inside: avoid;">
               <!-- 1. sno -->
               <td valign="top" style="text-align: center; padding-left: 6px; padding-right: 6px;"><?php echo $i + 1; ?></td>

               <!-- 2. description -->
               <td valign="top">
                  <span style="color: #000;"><?php echo '('.$billing_data->stock_code.') '.$billing_data->billing_description; ?></span><br />
                  <?php if ($data['item_details'][$i] != '') { ?>
                     <br />
                     <span style="font-style: oblique; color: dimgray; text-align: center">
                        <?php echo $data['item_details'][$i]; ?>
                     </span>
                  <?php } ?>
               </td>

               <?php if ($data['uom'][$i] != '' && $data['uom'][$i] != null) { ?>
                  <!-- 3. quantity & UOM -->
                  <td style="text-align: right" valign="top">
                     <?php echo $data['quantity'][$i].' '.$data['uom'][$i]; ?>
                  </td>

                  <!-- 4. unit price -->
                  <td style="text-align: right" valign="top">
                     <?php echo number_format($data['unit_price'][$i], 2); ?>
                  </td>

                  <!-- 5. discount -->
                  <td style="text-align: right" valign="top">
                     <?php echo $data['discount'][$i]; ?>
                  </td>
               <?php } else { ?>
                  <td></td>
                  <td></td>
               ...
               <!-- 6. item total -->
               <td style="text-align: right" valign="top">
                  <?php echo number_format($data['amount'][$i], 2); ?>
               </td>

               <?php if ($this->ion_auth->isGSTMerchant()) {
                   $gst_desc = $this->custom->getSingleValue('ct_gst', 'gst_description', ['gst_code' => $data['gst_code'][$i]]); ?>
                  <!-- 7. gst code & description -->
                  <td valign="top">
                     <?php echo $data['gst_code'][$i].' : '.$gst_desc.' ('.$data['gst_rate'][$i].'%)'; ?>
                  </td>

                  <!-- 8. gst - derived amount -->
                  <td valign="top" style="text-align: right">
                     <?php echo number_format($data['gst_amount'][$i], 2); ?>
                  </td>
               <?php } ?>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td class="second" width="350">
                           <?php echo number_format($data['sub_total'], 2); ?>
                        </td>
                     </tr>
                           ...
                           <table style="width: 100%" cellspacing="0" cellpadding="0">
                              <tr>
                                 <td style="border: none; text-align: left;">
                                    <?php if ($data['lsd_code'] == 'P') { ?>
                                       <span style="padding: 5px; background: #fff"><?php echo floatval($data['lsd_percentage']).' %'; ?></span>
                                    <?php } ?>
                                 </td>
                                 <td align="right" style="border: none; padding: 0">
                                    (<?php echo number_format($data['lsd_value'], 2); ?>)
                                 </td>
                              </tr>
                           </table>
                        </td>
                     ...
                     <tr>
                        ...
                        <td class="second">
                           <?php echo number_format($data['net_after_lsd'], 2); ?>
                        </td>
                     </tr>
                     ...
                     <?php if ($this->ion_auth->isGSTMerchant()) { ?>
                        <tr>
                           ...
                           <td class="second">
                              +<?php echo number_format($data['f_gst_total'], 2); ?>
                           </td>
                        </tr>
                     <?php } ?>
                     ...
                     <tr>
                        ...
                        <td class="second">
                           <?php echo number_format($data['f_net_total'], 2); ?>
                        </td>
                     </tr>
                     ...
                     <?php if ($customer_currency !== $system_currency) { ?>
                        <?php if ($this->ion_auth->isGSTMerchant()) { ?>
                           <tr>
                              ...
                              <td class="second">
                                 <?php echo number_format($data['gst_total'], 2); ?>
                              </td>
                           </tr>
                        <?php } ?>
                        ...
                        <tr>
                           ...
                           <td class="second">
                              <?php echo number_format($data['net_total'], 2); ?>
                           </td>
                        </tr>
                     <?php } ?>
                  </tbody>
      ...
      <div style="page-break-inside: avoid">
         ...
         <?php if ($data['payment_terms'] != '') { ?>
            <table style="width: 1000px;">
               <tr>
                  <td><strong>Payment Terms :</strong> <?php echo $data['payment_terms']; ?></td>
               </tr>
            </table>
         <?php } ?>
         ...
         <?php if ($data['order_notes'] != '') { ?>
            <table style="width: 1000px;">
               <tr>
                  <td><strong>Order Notes :</strong> <?php echo $data['order_notes']; ?></td>
               </tr>
            </table>
         <?php } ?>
         ...
         <?php if ($data['footer_notes'] != '') { ?>
            <table style="width: 1000px; background: #f5f5f5;">
               <tr>
                  <td style="text-align: center">
                     <span style="font-family: cursive; color: #C62168; font-style: italic;"><?php echo $data['footer_notes']; ?></span>
                  </td>
               </tr>
            </table>
         <?php } ?>
