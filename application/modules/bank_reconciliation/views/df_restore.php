<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0">Restore Bank Recon</h1>
         </div>
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="/"><i class="fa-solid fa-house"></i></a></li>
               <li class="breadcrumb-item active">Bank Recon</li>
            ...
            <form id="form_" method="post" enctype="multipart/form-data" action="<?php echo $save_url; ?>">
               <div class="card card-default">
                  ...
                  <div class="card-footer">
                     <a href="/bank_reconciliation/df_options" class="btn btn-info">Cancel</a>
   ...
   $(document).ready(function() {
      ...
      $('#btn_submit').click(function() {
         if($('#form_').valid()) {
            ...
            $('#confirmSubmitModal .modal-body').html("Please do backup before proceed to restore.<br />Restore will overwrite Bank Reconciliation data files in CRM System");
