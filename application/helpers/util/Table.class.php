...
class XBaseTable
{
    ...
    public function XBaseTable($name)
    {
        $this->name = $name;
    }
    ...
    public function toHTML($withHeader = true, $tableArgs = "border='1'", $trArgs = '', $tdArgs = '', $thArgs = '')
    {
    ...
    public function writeBytes($buf)
    {
