...
class Ion_auth
{
         ...
         if ($this->ion_auth_model->forgotten_password($identity)) {   //changed
            ...
            if ($user) {
               ...
               if (!$this->config->item('use_ci_email', 'ion_auth')) {
                  ...
                  $mail->setFrom('noreply@topjac.com', $this->config->item('site_title', 'ion_auth'));
                  $mail->addReplyTo($this->config->item('admin_email', 'ion_auth'), $this->config->item('site_title', 'ion_auth'));
    ...
    public function isGSTMerchant()
    {
        return $this->ion_auth_model->get_gst_merchant();
    }
